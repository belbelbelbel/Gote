      ...
      <AnimatePresence>
        {
          ...
          <motion.div
            ...
            className='flex flex-col gap-2 overflow-auto xl:pt-10  md:pt-[13rem] pt-[8rem] Account_slide  h-full inset-0 absolute md:fixed w-full  bg-[#f4f4f0] justify-center items-center text-center mx-auto' >
